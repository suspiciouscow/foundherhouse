...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Thanks to our partnerships with sponsors and VCs, we're able to offer subsidized housing at approximately $1000-$1300 per month, making it accessible for early-stage founders and builders."
    },
    {
